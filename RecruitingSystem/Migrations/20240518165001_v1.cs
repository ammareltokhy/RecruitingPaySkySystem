        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Is_Enable = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_Vacancy = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    Experience_needed = table.Column<int>(type: "int", nullable: false),
                    ...
                    Is_Deactivated = table.Column<bool>(type: "bit", nullable: false),
                    NumberOfAplications = table.Column<int>(type: "int", nullable: false),
                    Actual_NumberOfAplications = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_Application = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Expected_Salary = table.Column<double>(type: "float", nullable: false),
                    Number_Year_Experience = table.Column<string>(type: "nvarchar(max)", nullable: false),
